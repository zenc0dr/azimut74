let BEX = new Vue({
    ...
    mounted: function () {
        ...
        console.log('mounted: plugins/mcmraak/rivercrs/assets/js/pro-kruiz.booking.js')
    ...
    methods: {
        ...
        sendBooking() {
            ...
            this.sync(this.form, '/prok/api/booking', 'post', (data) => {
        ...
        openInfo(cabin) {
            ...
            this.silentSync('/prok/api/openCabinInfo', {cabin_id}, (response) => {
        ...
        openCabin(cabin) {
            ...
            this.silentSync('/prok/api/openCabin', send_data, (response) => {

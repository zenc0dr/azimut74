        ...
        <div v-if="show_list" class="ztms-list" v-click-outside="closeList">
            ...
            <div class="ztms-options">
                ...
                <template v-if="geoTree" v-for="itemL1 in geoTree">
                    ...
                    <div v-if="filterGate(itemL1.name)" :class="{selected:isSelected(itemL1.id)}"
                         class="ztms-item ztms-country">{{ itemL1.name }}
                    </div>
                    ...
                    <div class="ztms-group" v-if="itemL1.items" v-for="itemL2 in itemL1.items">
                        ...
                        <div v-if="filterGate(itemL2.name)" @click="addSelected(itemL2.id)"
                             :class="{selected:isSelected(itemL2.id)}" class="ztms-item">
                        ...
                        <div class="ztms-group" v-if="itemL2.items" v-for="itemL3 in itemL2.items">
                            ...
                            <div v-if="filterGate(itemL3.name)" @click="addSelected(itemL3.id)"
                                 :class="{selected:isSelected(itemL3.id)}" class="ztms-item">
                            ...
                            <div class="ztms-group" v-if="itemL3.items" v-for="itemL4 in itemL3.items">
                                <div v-if="filterGate(itemL4.name)" @click="addSelected(itemL4.id)"
                                     :class="{selected:isSelected(itemL4.id)}" class="ztms-item">
...
export default {
    ...
    computed: {
        selectedName() {
            if (!this.output || this.output.length == 0) return this.noSelect
